...
describe("mapTopicsPayload", () => {
  it("normalizes missing topic fields", () => {
    ...
    expect(mapped.platforms.weibo).toEqual([
      { title: "A", url: "", hot_value: "", category: "", platform: undefined, rank: undefined, topic_key: "", velocity: undefined },
      { title: "B", url: "/b", hot_value: "", category: "", platform: undefined, rank: undefined, topic_key: "", velocity: undefined },
    ]);
